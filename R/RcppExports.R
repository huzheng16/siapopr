...
#' }
#' @export
siapop <- function(tot_life = 40000.0, max_pop = 10000L, start_time = 0.0, ancestors = 1L, ancestor_clones = 1L, num_sims = 1L, allow_extinction = TRUE, num_samples = 0L, sample_size = 0L, passage = 0L, detection_threshold = 0.0, observation_frequency = 0.0, observation_times = NULL, birth_rate = 1.5, death_rate = 1.0, mutation_prob = 0.0, fitness_distribution = NULL, custom_distribution_file = NULL, alpha_fitness = 0.0, beta_fitness = 0.0, pass_prob = 1.0, upper_fitness = 0.0, lower_fitness = 0.0, alpha_mutation = 0.0, beta_mutation = 0.0, trace_ancestry = TRUE, count_alleles = TRUE, punctuated_prob = 0.0, poisson_param = 1.0, punctuated_multiplier = 1.0, punctuated_advantageous_prob = 1.0, epistatic_mutation_thresh = 1.0, epistatic_multiplier = 1.0, seed = NULL, custom_model_file = NULL, input_file = NULL, output_dir = NULL, ancestor_file = NULL) {
    .Call('siapopr_siapop', PACKAGE = 'siapopr', tot_life, max_pop, start_time, ancestors, ancestor_clones, num_sims, allow_extinction, num_samples, sample_size, passage, detection_threshold, observation_frequency, observation_times, birth_rate, death_rate, mutation_prob, fitness_distribution, custom_distribution_file, alpha_fitness, beta_fitness, pass_prob, upper_fitness, lower_fitness, alpha_mutation, beta_mutation, trace_ancestry, count_alleles, punctuated_prob, poisson_param, punctuated_multiplier, punctuated_advantageous_prob, epistatic_mutation_thresh, epistatic_multiplier, seed, custom_model_file, input_file, output_dir, ancestor_file)
}
